...
df1=pd.read_excel("./datasets/india_all_state.xlsx")
df=pd.read_excel("./datasets/Indian Coordinates.xlsx")

df_full=pd.merge(df,df1,on='Name of State / UT')
print(df_full)
print(df_full.columns)

map =folium.Map(location=[20,70],zoom_start=3.75,tiles='Stamen Terrain')
...
map.save('./datasets/India_state.html')
#to open file automatically
output_file = 'India_state.html'
new = 2
